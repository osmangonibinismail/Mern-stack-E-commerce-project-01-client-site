    ...
    <div className='container mx-auto p-4'>
      ...
      <div className='hidden lg:grid lg:grid-cols-[200px,1fr]'>
        ...
        <div className='bg-white p-2 min-h-[calc(100vh-120px)] overflow-y-scroll'>
          ...
          {/* sort by */}
          <div className=''>
            <h3 className='text-base text-slate-600 uppercase font-medium border-b-2 border-slate-300 pb-1'>Sort by</h3>
          ...
          {/* filter by */}
          <div className=''>
            <h3 className='text-base text-slate-600 uppercase font-medium border-b-2 border-slate-300 pb-1'>Category</h3>
        ...
        <div className='px-4'>
          ...
          <div className='min-h-[calc(100vh-120px)] overflow-y-scroll max-h-[calc(100vh-120px)]'>
            {
              data.length !== 0 && (
                <VerticalCartt data={data} loading={loading} />
              )
            }
          </div>
        </div>
